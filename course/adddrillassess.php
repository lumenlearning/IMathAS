...
?>
		...
		<!-- ############################### OHM SPECIFIC CHANGES ########################################### -->
		<span class=form>Due Date:</span><span class=formright>
			<input type=radio name="edatetype" value="2000000000" <?php writeHtmlChecked($enddate,'2000000000',0) ?>/> 		<!-- ############################### OHM SPECIFIC CHANGES ########################################### -->Always open after Start Date<br/>
