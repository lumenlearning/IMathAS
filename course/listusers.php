	...
	if (isset($_GET['assigncode'])) {
		...
		if (isset($_POST['SID'])) {
			...
			if ($errors != '') {
				...
				$query = "INSERT INTO imas_users (SID, password, rights, FirstName, LastName, email, msgnotify, forcepwreset, created_at) ";
				$query .= "VALUES (:SID, :password, :rights, :FirstName, :LastName, :email, :msgnotify, 1, :created_at);";
				$stm = $DBH->prepare($query);
