...
if ($myrights<20) {
	...
	$query = "SELECT imas_fakeusers.email,imas_questionset.author,imas_questionset.description,imas_questionset.lastmoddate,imas_questionset.ancestors,imas_questionset.deleted,imas_questionset.ownerid,imas_questionset.broken,imas_questionset.replaceby ";
	$query .= "FROM imas_fakeusers,imas_questionset WHERE imas_fakeusers.id=imas_questionset.ownerid AND imas_questionset.id='{$_GET['qsetid']}'";
	...
	$query = "SELECT imas_libraries.name,imas_fakeusers.LastName,imas_fakeusers.FirstName FROM imas_libraries,imas_library_items,imas_fakeusers  WHERE imas_libraries.id=imas_library_items.libid AND imas_library_items.ownerid=imas_fakeusers.id AND imas_library_items.qsetid='{$_GET['qsetid']}'";
