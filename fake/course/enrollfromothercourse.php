...
if (!isset($teacherid)) { // loaded by a NON-teacher
	...
	if (isset($_POST['process'])) {
		...
		$query = "SELECT iu.FirstName,iu.LastName,iu.id FROM imas_fakeusers AS iu JOIN imas_students ON iu.id=imas_students.userid WHERE imas_students.courseid='$source' ORDER BY iu.LastName,iu.FirstName";
