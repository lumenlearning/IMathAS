...
function gbtable() {
	...
	//Pull student data
	$ln = 1;
	$query = "SELECT imas_fakeusers.id,imas_fakeusers.SID,imas_fakeusers.FirstName,imas_fakeusers.LastName,imas_fakeusers.SID,imas_fakeusers.email,imas_students.section,imas_students.code ";
