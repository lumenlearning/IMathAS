...
<?php
		$query = "SELECT COUNT(imas_fakeusers.id) FROM imas_fakeusers,imas_students WHERE imas_fakeusers.id=imas_students.userid ";
		...
		*/
		...
		if ($_GET['gbitem']=="new") {
			$query = "SELECT imas_fakeusers.id,imas_fakeusers.LastName,imas_fakeusers.FirstName,imas_students.section,imas_students.locked ";
			$query .= "FROM imas_fakeusers,imas_students WHERE ";
			$query .= "imas_fakeusers.id=imas_students.userid AND imas_students.courseid='$cid'";
		} else {
			...
			$query = "SELECT imas_fakeusers.id,imas_fakeusers.LastName,imas_fakeusers.FirstName,imas_students.section,imas_students.locked FROM imas_fakeusers,imas_students ";
			if ($_GET['grades']!='all') {
				$query .= "WHERE imas_fakeusers.id=imas_students.userid AND imas_fakeusers.id='{$_GET['grades']}' AND imas_students.courseid='$cid'";
			} else {
				$query .= "WHERE imas_fakeusers.id=imas_students.userid AND imas_students.courseid='$cid'";
			}
