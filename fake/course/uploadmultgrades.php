...
if (!(isset($teacherid))) {
	...
	if (isset($_POST['thefile'])) {
		...
		$query = "SELECT imas_fakeusers.id,imas_fakeusers.SID FROM imas_fakeusers JOIN imas_students ON imas_students.userid=imas_fakeusers.id WHERE imas_students.courseid='$cid'";
