<?php
	...
	if (isset($_GET['search']) && trim($_GET['search'])!='') {
		...
		$searchlikes3 = "(imas_fakeusers.LastName LIKE '%".implode("%' AND imas_fakeusers.LastName LIKE '%",$searchterms)."%')";
		if (isset($_GET['allforums'])) {
			$query = "SELECT imas_forums.id,imas_forum_posts.threadid,imas_forum_posts.subject,imas_forum_posts.message,imas_fakeusers.FirstName,imas_fakeusers.LastName,imas_forum_posts.postdate,imas_forums.name,imas_forum_posts.isanon FROM imas_forum_posts,imas_forums,imas_fakeusers ";
			...
			$query .= "AND imas_fakeusers.id=imas_forum_posts.userid AND imas_forums.courseid='$cid' AND ($searchlikes OR $searchlikes2 OR $searchlikes3)";
		} else {
			$query = "SELECT imas_forum_posts.forumid,imas_forum_posts.threadid,imas_forum_posts.subject,imas_forum_posts.message,imas_fakeusers.FirstName,imas_fakeusers.LastName,imas_forum_posts.postdate ";
			$query .= "FROM imas_forum_posts,imas_fakeusers WHERE imas_forum_posts.forumid='$forumid' AND imas_fakeusers.id=imas_forum_posts.userid AND ($searchlikes OR $searchlikes2 OR $searchlikes3)";
		}
		if ($dofilter) {
...
<?php
	...
	$query = "SELECT imas_forum_posts.*,imas_forum_threads.views as tviews,imas_fakeusers.LastName,imas_fakeusers.FirstName,imas_forum_threads.stugroupid FROM imas_forum_posts,imas_fakeusers,imas_forum_threads WHERE ";
	$query .= "imas_forum_posts.userid=imas_fakeusers.id AND imas_forum_posts.threadid=imas_forum_threads.id AND imas_forum_posts.parent=0 AND imas_forum_posts.forumid='$forumid' ";	
