<?php
	...
	if ($haspoints) {
		$query = "SELECT imas_forum_posts.*,imas_fakeusers.FirstName,imas_fakeusers.LastName,imas_fakeusers.email,imas_fakeusers.hasuserimg,imas_grades.score,imas_grades.feedback FROM ";
		$query .= "imas_forum_posts JOIN imas_fakeusers ON imas_forum_posts.userid=imas_fakeusers.id LEFT JOIN imas_grades ON imas_grades.gradetype='forum' AND imas_grades.refid=imas_forum_posts.id ";
