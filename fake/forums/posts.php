<?php
	...
	if ($postbeforeview && isset($studentid)) {
	...
	if ($oktoshow) {
		if ($haspoints) {
			$query = "SELECT imas_forum_posts.*,imas_fakeusers.FirstName,imas_fakeusers.LastName,imas_fakeusers.email,imas_fakeusers.hasuserimg,imas_grades.score,imas_grades.feedback,imas_students.section FROM ";
			$query .= "imas_forum_posts JOIN imas_fakeusers ON imas_forum_posts.userid=imas_fakeusers.id ";
			...
			$query = "SELECT imas_forum_posts.*,imas_fakeusers.FirstName,imas_fakeusers.LastName,imas_fakeusers.email,imas_fakeusers.hasuserimg,imas_students.section FROM ";
			$query .= "imas_forum_posts JOIN imas_fakeusers ON imas_forum_posts.userid=imas_fakeusers.id ";
			$query .= "LEFT JOIN imas_students ON imas_students.userid=imas_forum_posts.userid AND imas_students.courseid='$cid' ";
			$query .= "WHERE (imas_forum_posts.id='$threadid' OR imas_forum_posts.threadid='$threadid') ORDER BY imas_forum_posts.id";
			
			//$query = "SELECT imas_forum_posts.*,imas_fakeusers.FirstName,imas_fakeusers.LastName,imas_fakeusers.email,imas_fakeusers.hasuserimg from imas_forum_posts,imas_fakeusers ";
			//$query .= "WHERE imas_forum_posts.userid=imas_fakeusers.id AND (imas_forum_posts.id='$threadid' OR imas_forum_posts.threadid='$threadid') ORDER BY imas_forum_posts.id";	
		}
		$result = mysql_query($query) or die("Query failed : $query " . mysql_error());
