...
//(c) 2006 David Lippman
	...
	*/
	...
	if (count($lastpost)>0) {
		...
		$query .= "WHERE imas_forum_posts.userid=imas_fakeusers.id AND imas_forum_posts.threadid IN ($threadids) AND imas_forum_posts.parent=0 ORDER BY imas_forum_posts.forumid";
		$result = mysql_query($query) or die("Query failed : $query " . mysql_error());
