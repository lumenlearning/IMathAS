...
//(c) 2006 David Lippman
	...
	*/
	...
	if (count($lastpost)>0) {
		...
		$query = "SELECT imas_forum_posts.*,imas_fakeusers.LastName,imas_fakeusers.FirstName,imas_forum_threads.lastposttime FROM imas_forum_posts,imas_fakeusers,imas_forum_threads ";
		$query .= "WHERE imas_forum_posts.userid=imas_fakeusers.id AND imas_forum_posts.threadid=imas_forum_threads.id AND ";
