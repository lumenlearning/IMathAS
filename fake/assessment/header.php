...
echo "<script type=\"text/javascript\" src=\"$imasroot/javascript/general.js?ver=121713\"></script>\n";
...
if (!isset($sessiondata['mathdisp'])) {
	...
	echo "<script type=\"text/javascript\" src=\"$imasroot/javascript/ASCIIMathML_min.js?v=112513\"></script>\n";
	...
	echo "<script src=\"$imasroot/javascript/ASCIIMathTeXImg_min.js?v=112513\" type=\"text/javascript\"></script>\n";
	...
	echo '<script type="text/javascript">var AMTcgiloc = "'.$mathimgurl.'";</script>';
	echo "<script src=\"$imasroot/javascript/ASCIIMathTeXImg_min.js?ver=112313\" type=\"text/javascript\"></script>\n";
...
if ($sessiondata['graphdisp']==1) {
	echo "<script src=\"$imasroot/javascript/ASCIIsvg_min.js?v=010714\" type=\"text/javascript\"></script>\n";
	echo "<script type=\"text/javascript\">var usingASCIISvg = true;</script>";
} else {
	echo "<script src=\"$imasroot/javascript/mathjs.js?v=010714\" type=\"text/javascript\"></script>\n";
...
<script type="text/javascript" src="<?php echo $imasroot;?>/javascript/drawing_min.js?v=060213"></script>
<?php
