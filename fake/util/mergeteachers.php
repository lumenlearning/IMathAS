...
if (empty($_POST['from']) || empty($_POST['to'])) {
	$query = "SELECT id, LastName, FirstName, SID, lastaccess FROM imas_fakeusers WHERE rights>11 ORDER BY LastName, FirstName";
...
$query = "DELETE FROM imas_fakeusers WHERE id='$from'";
mysql_query($query) or die("Query failed : " . mysql_error());
