...
<?php
	$query = "SELECT imas_msgs.id,imas_msgs.title,imas_msgs.senddate,imas_msgs.replied,imas_fakeusers.LastName,imas_fakeusers.FirstName,imas_msgs.isread,imas_courses.name ";
