<?php
	...
	$query = "SELECT imas_msgs.*,imas_fakeusers.FirstName,imas_fakeusers.LastName,imas_fakeusers.email from imas_msgs,imas_fakeusers ";
	$query .= "WHERE imas_msgs.msgfrom=imas_fakeusers.id AND (imas_msgs.id='$baseid' OR imas_msgs.baseid='$baseid') ORDER BY imas_msgs.id";
	$result = mysql_query($query) or die("Query failed : $query " . mysql_error());
