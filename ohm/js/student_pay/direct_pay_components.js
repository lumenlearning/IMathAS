var directPayComponents = (function (React) {
  ...
  var _taxPageWrapper$headi;

  var styles$1 = (_taxPageWrapper$headi = {
    taxPageWrapper: {
  ...
  }, defineProperty(_taxPageWrapper$headi, 'taxInputZip', {
    display: 'block',
    height: '36px',
    borderRadius: '3px',
    backgroundColor: '#fff',
    ...
    marginBottom: '16px',
    width: '120px'
  }), defineProperty(_taxPageWrapper$headi, 'taxInputLabelError', {
    display: 'block',
    width: '262px',
    height: '36px',
    borderRadius: '3px',
    ...
    padding: '0 6px',
    marginBottom: '40px'
  }), defineProperty(_taxPageWrapper$headi, 'taxInputError', {
    backgroundColor: '#FEF4F4',
    border: 'solid #FA8585 1px',
    borderRadius: '2px',
    display: 'inline-block',
    fontSize: '14px',
    marginBottom: '24px',
  ...
  }), defineProperty(_taxPageWrapper$headi, 'errorIcon', {
    width: '20px',
    height: '20px',
    display: 'inline-block',
    verticalAlign: 'middle'
  }), defineProperty(_taxPageWrapper$headi, 'table', {
    maxWidth: '278px',
    marginBottom: '47px'
  }), defineProperty(_taxPageWrapper$headi, 'tableHead', {
    fontSize: '14px',
    fontWeight: 'bold',
    borderBottom: 'solid 1px #ebecf0',
    paddingBottom: '10px',
    marginBottom: '10px'
  }), defineProperty(_taxPageWrapper$headi, 'columnOne', {
    display: 'table',
    fontSize: '14px',
    width: '278px',
    marginBottom: '12px'
  }), defineProperty(_taxPageWrapper$headi, 'assessmentActivation', {
    display: 'table-cell',
    textAlign: 'left'
  }), defineProperty(_taxPageWrapper$headi, 'preTaxValue', {
    display: 'table-cell',
    textAlign: 'right'
  }), defineProperty(_taxPageWrapper$headi, 'columnTwo', {
    display: 'table',
    fontSize: '14px',
    width: '278px',
    borderBottom: 'solid 1px #ebecf0',
    paddingBottom: '10px',
    marginBottom: '10px'
  }), defineProperty(_taxPageWrapper$headi, 'taxes', {
    display: 'table-cell',
    textAlign: 'left'
  }), defineProperty(_taxPageWrapper$headi, 'taxValueToCollect', {
    display: 'table-cell',
    textAlign: 'right'
  }), defineProperty(_taxPageWrapper$headi, 'columnThree', {
    display: 'table',
    fontSize: '14px',
    width: '278px'
  }), defineProperty(_taxPageWrapper$headi, 'total', {
    display: 'table-cell',
    textAlign: 'left'
  }), defineProperty(_taxPageWrapper$headi, 'totalValueToCollect', {
    display: 'table-cell',
    textAlign: 'right'
  }), defineProperty(_taxPageWrapper$headi, 'payNow', {
    fontSize: '14px',
    color: '#fff',
    width: '90px',
    height: '36px',
    ...
    cursor: 'pointer'
  }), defineProperty(_taxPageWrapper$headi, 'changeAddressButton', {
    ...
    margin: '16px 0',
    padding: 0
  }), defineProperty(_taxPageWrapper$headi, 'formButtonWrapper', {
    display: 'flex',
    justifyContent: 'flex-end',
    width: '288px'
  }), defineProperty(_taxPageWrapper$headi, 'lumenAttributionWrapper', {
    display: 'flex',
    alignItems: 'center',
    fontSize: '12px',
    marginTop: '4em'
  }), defineProperty(_taxPageWrapper$headi, 'lumenLogo', {
    height: '41px',
    marginLeft: '1em',
    width: '88.7px'
  }), defineProperty(_taxPageWrapper$headi, 'lumenLogoLink', {
    height: '41px'
  }), _taxPageWrapper$headi);
    ...
    createClass(DirectPayButton, [{
      ...
      value: function render() {
        return React.createElement(
          'div',
          { id: 'payment-button-container', className: 'form-control fs-exclude', style: { paddingBottom: '13px', paddingTop: '13px' } },
          React.createElement(
            'form',
            ...
            React.createElement('input', { type: 'hidden', id: 'state', name: 'state', value: this.props.state })
          )
        );
      }
    }, {
  ...
  var CheckoutTaxSummaryPage = function (_React$Component) {
    inherits(CheckoutTaxSummaryPage, _React$Component);

    function CheckoutTaxSummaryPage(props) {
      classCallCheck(this, CheckoutTaxSummaryPage);

      var _this = possibleConstructorReturn(this, (CheckoutTaxSummaryPage.__proto__ || Object.getPrototypeOf(CheckoutTaxSummaryPage)).call(this, props));
    ...
    createClass(CheckoutTaxSummaryPage, [{
      key: 'render',
      value: function render() {
        return React.createElement(
          'div',
          ...
          React.createElement(
            'button',
            { type: 'button',
              style: styles$1.changeAddressButton,
              onClick: this.props.toggleSummaryPage },
            'Change Address'
          ),
          React.createElement(
            'div',
          ...
          React.createElement(
            'div',
            { style: styles$1.formButtonWrapper },
  ...
  var CheckoutTaxPage = function (_React$Component) {
    ...
    function CheckoutTaxPage(props) {
      ...
      _this.state = {
        ...
        total: '-',
        errors: [],
        renderSummaryPage: false
      };

      _this._handleInputChange = _this._handleInputChange.bind(_this);
      _this._formatZipcode = _this._formatZipcode.bind(_this);
      _this._handleFormSubmit = _this._handleFormSubmit.bind(_this);
      _this._toggleSummaryPage = _this._toggleSummaryPage.bind(_this);
      _this._getTaxAmount = _this._getTaxAmount.bind(_this);
      return _this;
    }
    ...
    createClass(CheckoutTaxPage, [{
      key: 'render',
      value: function render() {
        if (!this.state.renderSummaryPage) {
          return React.createElement(
            'div',
            ...
            React.createElement(
              ...
              React.createElement(
                'label',
                { htmlFor: 'address', style: styles$1.taxInputLabel },
                'Street Address'
              ),
              ...
              React.createElement(
                'label',
                { htmlFor: 'city', style: styles$1.taxInputLabel },
                'City'
              ),
              React.createElement('input', {
                type: 'text',
              ...
              React.createElement(
                'label',
                { htmlFor: 'state', style: styles$1.taxInputLabel },
                'State'
              ),
              React.createElement(
                'select',
                {
                  id: 'state',
                  name: 'state',
                  style: _extends({}, styles$1.taxInput, styles$1.taxInputState),
                  onChange: this._handleInputChange,
              ...
              React.createElement(
                'label',
                { htmlFor: 'zipcode', style: styles$1.taxInputLabel },
                'Zip Code'
              ),
              React.createElement('input', {
                type: 'text',
                id: 'zipcode',
                name: 'zipcode',
                style: _extends({}, styles$1.taxInput, styles$1.taxInputZip),
                onChange: this._handleInputChange,
          ...
          return React.createElement(
            ...
            React.createElement(CheckoutTaxSummaryPage, {
              toggleSummaryPage: this._toggleSummaryPage.bind(this),
              address: this.state.address,
              city: this.state.city,
              state: this.state.state,
              zipcode: this.state.zipcode,
              preTaxValue: this._convertToDollars(this.props.amount_in_cents),
              taxAmount: this._convertToDollars(this.state.taxAmount),
              total: this._convertToDollars(this.state.total),
              stripeKey: this.props.stripeKey,
              paymentStatus: this.props.paymentStatus,
              chargeAmount: this.state.total,
              institutionName: this.props.institutionName,
      ...
      key: '_toggleSummaryPage',
      value: function _toggleSummaryPage() {
        this.setState({
          renderSummaryPage: !this.state.renderSummaryPage
        });
      }
    }, {
      ...
      value: function _handleInputChange(event) {
        ...
        this.setState(defineProperty({}, name, value));
      ...
      key: '_formatZipcode',
      value: function _formatZipcode() {
        if (this.state.zipcode.length > 6 && this.state.zipcode.indexOf("-") === -1) {
          this.setState({
            zipcode: this.state.zipcode.substring(0, 5) + "-" + this.state.zipcode.substring(5)
          });
        }
      }
    }, {
          ...
          promise.then(function (value) {
            if (value.errors != undefined) {
              ...
              _this2.setState({
                ...
                zipcode: _this2.state.zipcode
              });
              _this2._toggleSummaryPage();
            }
          });
        });
      }
      ...
      value: function _getTaxApiUrl() {
        if (window.location.host.indexOf('ludev.team') !== -1) {
          ...
          return 'http://localhost:3002/api/student_pay/tax';
        } else {
