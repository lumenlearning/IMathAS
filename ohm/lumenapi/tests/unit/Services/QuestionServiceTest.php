...
class QuestionServiceTest extends TestCase
{
    ...
    public function testGetQuestionsWithAnswers(): void
    {
        ...
        $this->assertEmpty($questionsWithAnswers[0]['questionComponents']); # empty when not available on questions
        ...
        $this->assertEmpty($questionsWithAnswers[1]['questionComponents']); # empty when not available on questions
