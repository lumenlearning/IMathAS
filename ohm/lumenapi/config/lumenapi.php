...
$GLOBALS['QUESTIONS_API']['EDITABLE_QTEXT_HTML_TAGS'] = explode(',', getenv('QUESTIONS_API_EDITABLE_QTEXT_HTML_TAGS') ?: 'p,div,span,br,a,ol,ul,li,img,table,tr,th,td,caption,col,colgroup,thead,tbody,tfoot');
