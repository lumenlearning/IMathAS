  ...
  <div class="tab-content shadowBox non-nav-tab-item col-md-12 col-sm-12">
    <div class="name-of-item">
      ...
      <div class="col-md-10 col-sm-9">
        ...
        <?= $form->field($model,'name')->textInput(['value'=>$title,'maxlength' => "60" , 'id'=> 'name-forum', 'type'=> 'text', 'size'=> '0','style'=>'width: 100%;height: 40px; border: #a9a9a9 1px solid;' , 'class'=>"name form-control"])->label(false); ?>
      </div>
    </div>
    <BR class=form>
      ...
      <div class="editor-summary col-md-12 col-sm-12 padding-left-zero padding-right-zero">
        ...
        <div class="col-md-10 col-sm-9 padding-left-zero padding-right-zero">
          <div class="col-md-12 col-sm-12 editor add-forum-summary-textarea">
            ...
            <?= $form->field($model, 'description')->textArea(['value' => HtmlPurifier::process($description),
            'id' =>'description','style'=>'width: 100%','rows' => '12', 'cols' => '5'])->label(false); ?>
