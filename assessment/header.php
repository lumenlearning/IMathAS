...
<script src="<?php echo $imasroot . "/javascript/assessment_min.js?v=040418b";?>" type="text/javascript"></script>

<?php
/*
<script src="<?php echo $imasroot . "/javascript/general.js?v=012618";?>" type="text/javascript"></script>
<script src="<?php echo $imasroot . "/javascript/mathjs.js?v=040418";?>" type="text/javascript"></script>
<script src="<?php echo $imasroot . "/javascript/AMhelpers.js?v=040418";?>" type="text/javascript"></script>
