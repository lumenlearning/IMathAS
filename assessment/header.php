...
<link rel="stylesheet" href="<?php echo $imasroot . "/assessment/mathtest.css?ver=011819";?>" type="text/css"/>
<?php
...
if (isset($sessiondata['coursetheme'])) {
	...
	echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"$imasroot/themes/$coursetheme?v=110918\"/>\n";
}
...
echo '<script src="' . $imasroot . '/javascript/assessment_min.js?v=122318" type="text/javascript"></script>';
...
echo '<script src="' . $imasroot . '/javascript/drawing.js?v=121718" type="text/javascript"></script>';
