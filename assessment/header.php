...
echo '<script src="' . $imasroot . '/javascript/assessment_min.js?v=102218" type="text/javascript"></script>';
...
echo '<script src="' . $imasroot . '/javascript/drawing.js?v=102218" type="text/javascript"></script>';
