...
<script src="<?php echo $imasroot . "/javascript/assessment_min.js?v=052617b";?>" type="text/javascript"></script>
...
<script src="<?php echo $imasroot . "/javascript/AMhelpers.js?v=052617c";?>" type="text/javascript"></script>
