...
<h2>More about WAMAP/IMathAS</h2>
...
management tools, including posting of announcements, text files, and attachments, as
well as discussion forums.  In postings, assessments, and forums, IMathAS allows
accurate display of math and graphs, with simple calculator-style math entry and
...
<p class="ind">WAMAP has been generously funded by the <a href="http://www.transitionmathproject.org">Transition Math Project</a> to
provide free use of the IMathAS system by High School and College instructors throughout the state of Washington.  Of course, if
you'd prefer, you can also <a href="http://imathas.sourceforge.net">download</a> and install the software on your local webserver.</p>


<p class="ind">This site will also serve as a repository of shared questions to which you can contribute questions you have written.</p>


<h2>How to get Started</h2>
<p class="ind">To get an account and get started,
<ol>
<li>Fill out a <a href="/newinstructor.php">New Instructor Account Request</a>.  This request is processed by hand, so please allow several days for a response.</li>
<li>Read the <a href="/docs/docs.php">Use Guides</a>, especially the <a href="/docs/gettingstarted.html">Getting Started in IMathAS</a> guide.</li>
</ol>
</p>
</body>
</html>
