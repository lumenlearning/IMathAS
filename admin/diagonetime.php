...
if ($overwriteBody==1) { //NO AUTHORITY
	...
	if (isset($_GET['generate'])) {
		if (isset($_POST['n'])) {
			echo "<b>Newly generated passwords</b> <a href=\"diagonetime.php?id=" . Sanitize::encodeUrlParam($diag) . "&view=true\">View all</a>";
			...
			echo "<form method=\"post\" action=\"diagonetime.php?id=" . Sanitize::encodeUrlParam($diag) . "&generate=true\">";
