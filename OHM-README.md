...
### Running OHM locally
0. Ensure you have installed Docker, PHP (version 7.3), Homebrew 
	0.1 Homebrew: https://brew.sh/
	0.2 Docker: https://www.docker.com/get-started
	0.3 PHP: 'brew install php@7.3' in terminal
