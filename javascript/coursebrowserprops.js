var courseBrowserProps = {
	...
	"book": {
		...
		"options": {
			...
			"osprea": "Prealgebra, OpenStax/Marecek/Anthony-Smith",
			...
			"osbega": "Elementary Algebra, OpenStax/Marecek/Anthony-Smith",
			"crbega": "Elementary Algebra, College of the Redwoods",
			"wa": "Beginning and Intermediate Algebra, Wallace",
			"osia": "Intermediate Algebra, OpenStax/Maracek",
			"sccia": "Intermediate Algebra, Scottsdale CC",
			"cria": "Intermediate Algebra, College of the Redwoods",
			"group3": "College Algebra / Precalc / Trig",
            "lumencolalg": "College Algebra, Lumen Learning",
			"szcola": "College Algebra, Stitz/Zeager",
			"oscola": "College Algebra, OpenStax",
			"oscolat": "College Algebra + Trig, OpenStax",
			"lrprec": "Precalculus, Lippman/Rasmussen",
			"szprec": "Precalculus, Stitz/Zeager",
			"osprec": "Precalculus, OpenStax",
			"group4": "Calculus",
			"dhcalc": "Contemporary Calculus, Hoffman",
			"dgcalc": "Community Calculus, Guichard/et al",
			"apcalc": "APEX Calculus, Hartman/et al",
			"accalc": "Active Calculus, Boalkins",
			"oscalc": "Calculus, OpenStax/Strang/Herman",
			...
			"jflina": "Linear Algebra, Hefferon",
			"rblina": "First Course in Linear Algebra, Beezer",
