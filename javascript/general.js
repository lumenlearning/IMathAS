...
function initeditor(edmode,edids,css,inline,setupfunction,extendsetup){
	...
	var edsetup = {
		...
		inline: inlinemode,
		license_key: 'gpl',
		cache_suffix: '?v=062526',
		plugins: "lists advlist autolink image charmap anchor searchreplace code link media table rollups asciimath asciisvg attach snippet emoticons accordion ableplayer drawing",
		menubar: false,
