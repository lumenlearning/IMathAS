...
?>
<link rel="stylesheet" href="<?php echo $staticroot . "/imascore.css?ver=070226";?>" type="text/css">
<?php
$isfw = false;
...
<script src="<?php echo $staticroot;?>/javascript/general.js?v=070226"></script>
<?php
