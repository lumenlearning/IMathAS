...
if (isset($coursetheme)) {
	...
	?>
<link rel="stylesheet" href="<?php echo $imasroot . "/themes/$coursetheme?v=112019";?>" type="text/css" />
...
<script type="text/javascript" src="<?php echo $imasroot;?>/javascript/general.js?v=111619"></script>
<?php
...
if (isset($useeditor) && $sessiondata['useed']==1) {
	echo '<script type="text/javascript" src="'.$imasroot.'/tinymce4/tinymce_bundled.min.js?v=20200310"></script>';
	echo "\n";
