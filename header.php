...
?>
<link rel="stylesheet" href="<?php echo $staticroot . "/imascore.css?ver=070126";?>" type="text/css">
<?php
$isfw = false;
...
<script src="<?php echo $staticroot;?>/javascript/general.js?v=0070126"></script>
<?php
...
if ((isset($useeditor) && $_SESSION['useed']==1) || // using editor
	...
	echo '</script>';
	echo "<script src=\"$staticroot/javascript/ASCIIMathTeXImg_min.js?ver=061426\"></script>\n";
}
if (!isset($_SESSION['mathdisp'])) {
    ...
    echo "<script src=\"$staticroot/javascript/mathjaxconfig.js?ver=061426\"></script>\n";
...
if (isset($_SESSION['graphdisp']) && $_SESSION['graphdisp']==1) {
	echo "<script src=\"$staticroot/javascript/ASCIIsvg_min.js?v=062526\"></script>\n";
